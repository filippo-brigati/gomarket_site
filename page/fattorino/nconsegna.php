            ...
            <div class='modal fade' id='deleteModal' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                <div class='modal-dialog'>
                    ...
                    <div class='modal-footer'>
                        ...
                        <a type='button' class='btn btn-outline-danger' href='../../method/accept.php?id={$riga["ID"]}'>ELIMINA ORDINE</a>
                    </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-6'>
                            ...
                            <div class='d-grid gap-2 d-md-flex justify-content-md-start'>
                                <a href='./detordine.php?id={$riga["ID"]}' class='btn btn-outline-primary' type='button'>CONSEGNA ORDINE</a>
                            </div>
                        </div>
                    </div>
                </div>
